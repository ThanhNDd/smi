            ...
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="col-md-3 mb-2">
                        <select class="form-control order-status col-md-7 d-inline-block" name="order_status" id="order_status">
...
<script>
    ...
    function check_all() {
        $('#check_all_order').on('click', function () {
            $(this).parent().parent().parent().parent().find('td input:checkbox').trigger("click");
        });
    }
